        ...
        return (
            <div>
                ...
                <div className="main-box">
                    ...
                    <ChartLine data={avarageCostPerKm}
                                maxCost={maxCost}
                                avgCost={avgCost}/>
                </div>
                ...
                <div className="main-box">
                    ...
                    <div className="last-refueling">
                        ...
                        <p>{moment(lastDate).format(DATE_FORMAT)} <span className="text-grey">- {lastOdometer}Km</span></p>
                        <p>{lastVolume}L <span className="text-grey">by</span> {lastCost}Hrn/L <span className="text-grey">- {lastVolume * lastCost}Hrn</span></p>
                    </div>
                </div>
